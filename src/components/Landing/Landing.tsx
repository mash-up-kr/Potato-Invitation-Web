      ...
      <section>
        ...
        <article className={cx('article-character-choice')}>
          <div className={cx('article-wrapper')}>
            ...
            <p className={cx('article-description')}>다양한 약속 유형 캐릭터를 선택해 초대장을 더욱 특별하게 만들 수 있습니다</p>
        ...
        <article className={cx('article-chat')}>
          <div className={cx('article-wrapper')}>
            ...
            <p className={cx('article-description')}>초대장을 받으면 댓글 기능을 통해 초대된 사람들끼리 소통을 할 수 있습니다</p>
